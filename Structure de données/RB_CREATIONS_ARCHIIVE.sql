...
-- ----------------------------
-- Table structure for RB_CREATIONS_ARCHIIVE
-- ----------------------------
DROP TABLE IF EXISTS `RB_CREATIONS_ARCHIIVE`;
CREATE TABLE `RB_CREATIONS_ARCHIIVE` (
  `id0` double NOT NULL,
  ...
  `Temps_archivage` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id0`),
  KEY `Produit` (`Produit`),
